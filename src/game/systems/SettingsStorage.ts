...
export default class SettingsStorage {
  ...
  static saveMusicVolume(value: number): void {
    this.writeNumber(this.MUSIC_VOLUME_KEY, value);
  }

  static saveSfxVolume(value: number): void {
    this.writeNumber(this.SFX_VOLUME_KEY, value);
  }
